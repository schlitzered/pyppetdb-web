...
import ComponentPyppetdbNodesCRUD from '../ComponentPyppetdbNodesCRUD.vue'
...
describe('ComponentPyppetdbNodesCRUD', () => {
  it('mounts successfully', () => {
    const wrapper = mount(ComponentPyppetdbNodesCRUD, {
      global: {
        stubs: {
