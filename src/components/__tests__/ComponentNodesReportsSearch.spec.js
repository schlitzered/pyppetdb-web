...
import ComponentNodesReportsSearch from '../ComponentNodesReportsSearch.vue'
...
describe('ComponentNodesReportsSearch', () => {
  it('mounts successfully', () => {
    const wrapper = mount(ComponentNodesReportsSearch, {
      global: {
        stubs: {
