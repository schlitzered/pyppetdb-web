...
import ComponentHieraKeyModelsDynamicCRUD from '../ComponentHieraKeyModelsDynamicCRUD.vue'
...
describe('ComponentHieraKeyModelsDynamicCRUD', () => {
  it('mounts successfully', () => {
    const wrapper = mount(ComponentHieraKeyModelsDynamicCRUD, {
      global: {
        stubs: {
