...
import ComponentHieraLevelsSearch from '../ComponentHieraLevelsSearch.vue'
...
describe('ComponentHieraLevelsSearch', () => {
  it('mounts successfully', () => {
    const wrapper = mount(ComponentHieraLevelsSearch, {
      global: {
        stubs: {
