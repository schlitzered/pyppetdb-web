...
import ComponentCAAuthoritiesCRUD from '../ComponentCAAuthoritiesCRUD.vue'
...
describe('ComponentCAAuthoritiesCRUD', () => {
  it('mounts successfully', () => {
    const wrapper = mount(ComponentCAAuthoritiesCRUD, {
      global: {
        stubs: {
