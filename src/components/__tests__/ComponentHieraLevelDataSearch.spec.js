...
import ComponentHieraLevelDataSearch from '../ComponentHieraLevelDataSearch.vue'
...
describe('ComponentHieraLevelDataSearch', () => {
  it('mounts successfully', () => {
    const wrapper = mount(ComponentHieraLevelDataSearch, {
      global: {
        stubs: {
