...
import ComponentPyppetdbNodesSearch from '../ComponentPyppetdbNodesSearch.vue'
...
describe('ComponentPyppetdbNodesSearch', () => {
  it('mounts successfully', () => {
    const wrapper = mount(ComponentPyppetdbNodesSearch, {
      global: {
        stubs: {
