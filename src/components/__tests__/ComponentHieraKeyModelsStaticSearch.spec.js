...
import ComponentHieraKeyModelsStaticSearch from '../ComponentHieraKeyModelsStaticSearch.vue'
...
describe('ComponentHieraKeyModelsStaticSearch', () => {
  it('mounts successfully', () => {
    const wrapper = mount(ComponentHieraKeyModelsStaticSearch, {
      global: {
        stubs: {
