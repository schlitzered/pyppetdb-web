...
import ComponentHieraKeyModelsDynamicSearch from '../ComponentHieraKeyModelsDynamicSearch.vue'
...
describe('ComponentHieraKeyModelsDynamicSearch', () => {
  it('mounts successfully', () => {
    const wrapper = mount(ComponentHieraKeyModelsDynamicSearch, {
      global: {
        stubs: {
