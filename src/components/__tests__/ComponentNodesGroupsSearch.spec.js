...
import ComponentNodesGroupsSearch from '../ComponentNodesGroupsSearch.vue'
...
describe('ComponentNodesGroupsSearch', () => {
  it('mounts successfully', () => {
    const wrapper = mount(ComponentNodesGroupsSearch, {
      global: {
        stubs: {
