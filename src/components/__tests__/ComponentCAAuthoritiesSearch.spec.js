...
import ComponentCAAuthoritiesSearch from '../ComponentCAAuthoritiesSearch.vue'
...
describe('ComponentCAAuthoritiesSearch', () => {
  it('mounts successfully', () => {
    const wrapper = mount(ComponentCAAuthoritiesSearch, {
      global: {
        stubs: {
