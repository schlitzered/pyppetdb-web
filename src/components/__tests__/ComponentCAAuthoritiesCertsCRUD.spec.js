...
import ComponentCAAuthoritiesCertsCRUD from '../ComponentCAAuthoritiesCertsCRUD.vue'
...
describe('ComponentCAAuthoritiesCertsCRUD', () => {
  it('mounts successfully', () => {
    const wrapper = mount(ComponentCAAuthoritiesCertsCRUD, {
      global: {
        stubs: {
