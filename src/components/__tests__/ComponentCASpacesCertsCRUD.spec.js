...
import ComponentCASpacesCertsCRUD from '../ComponentCASpacesCertsCRUD.vue'
...
describe('ComponentCASpacesCertsCRUD', () => {
  it('mounts successfully', () => {
    const wrapper = mount(ComponentCASpacesCertsCRUD, {
      global: {
        stubs: {
