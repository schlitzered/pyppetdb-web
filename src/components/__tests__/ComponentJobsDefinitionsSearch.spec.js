...
import ComponentJobsDefinitionsSearch from '../ComponentJobsDefinitionsSearch.vue'
...
describe('ComponentJobsDefinitionsSearch', () => {
  it('mounts successfully', () => {
    const wrapper = mount(ComponentJobsDefinitionsSearch, {
      global: {
        stubs: {
