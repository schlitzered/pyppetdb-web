...
import ComponentHieraLookupSearch from '../ComponentHieraLookupSearch.vue'
...
describe('ComponentHieraLookupSearch', () => {
  it('mounts successfully', () => {
    const wrapper = mount(ComponentHieraLookupSearch, {
      global: {
        stubs: {
