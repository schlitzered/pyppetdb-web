...
import ComponentHieraKeyModelsStaticCRUD from '../ComponentHieraKeyModelsStaticCRUD.vue'
...
describe('ComponentHieraKeyModelsStaticCRUD', () => {
  it('mounts successfully', () => {
    const wrapper = mount(ComponentHieraKeyModelsStaticCRUD, {
      global: {
        stubs: {
