...
import ComponentJobsNodesJobsSearch from '../ComponentJobsNodesJobsSearch.vue'
...
describe('ComponentJobsNodesJobsSearch', () => {
  it('mounts successfully', () => {
    const wrapper = mount(ComponentJobsNodesJobsSearch, {
      global: {
        stubs: {
