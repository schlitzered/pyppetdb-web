...
import ComponentCASpacesCertsSearch from '../ComponentCASpacesCertsSearch.vue'
...
describe('ComponentCASpacesCertsSearch', () => {
  it('mounts successfully', () => {
    const wrapper = mount(ComponentCASpacesCertsSearch, {
      global: {
        stubs: {
