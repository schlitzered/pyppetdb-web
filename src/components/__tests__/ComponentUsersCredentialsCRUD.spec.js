...
import ComponentUsersCredentialsCRUD from '../ComponentUsersCredentialsCRUD.vue'
...
describe('ComponentUsersCredentialsCRUD', () => {
  it('mounts successfully', () => {
    const wrapper = mount(ComponentUsersCredentialsCRUD, {
      global: {
        stubs: {
