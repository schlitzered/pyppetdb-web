...
import ComponentNodesDistinctFactValues from '../ComponentNodesDistinctFactValues.vue'
...
describe('ComponentNodesDistinctFactValues', () => {
  it('mounts successfully', () => {
    const wrapper = mount(ComponentNodesDistinctFactValues, {
      global: {
        stubs: {
