...
import ComponentUsersCredentialsSearch from '../ComponentUsersCredentialsSearch.vue'
...
describe('ComponentUsersCredentialsSearch', () => {
  it('mounts successfully', () => {
    const wrapper = mount(ComponentUsersCredentialsSearch, {
      global: {
        stubs: {
