...
import ViewHieraKeyModelsStaticSearch from '../ViewHieraKeyModelsStaticSearch.vue'
...
describe('ViewHieraKeyModelsStaticSearch', () => {
  it('mounts successfully', () => {
    const wrapper = mount(ViewHieraKeyModelsStaticSearch, {
      global: {
        stubs: {
