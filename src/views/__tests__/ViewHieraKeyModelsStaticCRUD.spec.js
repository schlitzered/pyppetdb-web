...
import ViewHieraKeyModelsStaticCRUD from '../ViewHieraKeyModelsStaticCRUD.vue'
...
describe('ViewHieraKeyModelsStaticCRUD', () => {
  it('mounts successfully', () => {
    const wrapper = mount(ViewHieraKeyModelsStaticCRUD, {
      global: {
        stubs: {
