...
import ViewCAAuthoritiesCertsSearch from '../ViewCAAuthoritiesCertsSearch.vue'
...
describe('ViewCAAuthoritiesCertsSearch', () => {
  it('mounts successfully', () => {
    const wrapper = mount(ViewCAAuthoritiesCertsSearch, {
      global: {
        stubs: {
