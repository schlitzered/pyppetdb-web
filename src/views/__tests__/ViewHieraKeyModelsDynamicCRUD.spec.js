...
import ViewHieraKeyModelsDynamicCRUD from '../ViewHieraKeyModelsDynamicCRUD.vue'
...
describe('ViewHieraKeyModelsDynamicCRUD', () => {
  it('mounts successfully', () => {
    const wrapper = mount(ViewHieraKeyModelsDynamicCRUD, {
      global: {
        stubs: {
