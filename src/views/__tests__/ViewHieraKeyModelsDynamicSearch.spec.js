...
import ViewHieraKeyModelsDynamicSearch from '../ViewHieraKeyModelsDynamicSearch.vue'
...
describe('ViewHieraKeyModelsDynamicSearch', () => {
  it('mounts successfully', () => {
    const wrapper = mount(ViewHieraKeyModelsDynamicSearch, {
      global: {
        stubs: {
