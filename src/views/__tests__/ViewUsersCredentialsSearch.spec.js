...
import ViewUsersCredentialsSearch from '../ViewUsersCredentialsSearch.vue'
...
describe('ViewUsersCredentialsSearch', () => {
  it('mounts successfully', () => {
    const wrapper = mount(ViewUsersCredentialsSearch, {
      global: {
        stubs: {
