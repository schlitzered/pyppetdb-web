...
import ViewNodesDistinctFactValues from '../ViewNodesDistinctFactValues.vue'
...
describe('ViewNodesDistinctFactValues', () => {
  it('mounts successfully', () => {
    const wrapper = mount(ViewNodesDistinctFactValues, {
      global: {
        stubs: {
