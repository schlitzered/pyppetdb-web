...
import ViewCAAuthoritiesCertsCRUD from '../ViewCAAuthoritiesCertsCRUD.vue'
...
describe('ViewCAAuthoritiesCertsCRUD', () => {
  it('mounts successfully', () => {
    const wrapper = mount(ViewCAAuthoritiesCertsCRUD, {
      global: {
        stubs: {
